...
def test_stacked_area_attributes():
    ...
    assert stacked_area.metadata['series']['yaxis'][1]['value_description'] == 'Details Quantity'
...
def test_stacked_bar_vertical_attributes():
    ...
    assert stacked_bar_vertical.metadata['series']['yaxis'][1]['value_description'] == 'Details Quantity'
...
def test_detailed_summary_attributes():
    ...
    assert detailed_summary.metadata['header_columns'][0]['label_description'] == 'Operating System'
