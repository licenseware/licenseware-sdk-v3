import pytest
import unittest
from licenseware.validators.validate_required_items import validate_required_items, _handle_response
...
def test_handle_response():
    ...
    res = _handle_response(missing_items=["col1"], item_type="column", raise_error=False)
    assert 'col1' in res
