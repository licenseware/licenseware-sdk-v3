...
def _update_bools(prop:str, editable:bool, visible:bool, hashable:bool, required:bool):
...
class DataTable:
    ...
    def column(
        ...
        *,
        ...
        editable, visible, hashable, required = _update_bools(prop, editable, visible, hashable, required)
